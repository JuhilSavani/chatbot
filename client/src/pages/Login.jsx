    ...
    <div className="antialiased min-h-dvh flex items-center justify-center relative overflow-hidden bg-[#09090b] text-[#fafafa] font-sans">
      ...
      <div className="w-full max-w-lg p-6 relative z-10">
          ...
          <div className="glass-card rounded-xl p-8 shadow-2xl">
              ...
              {loginError && (
                <div className="mb-6 p-4 rounded-lg bg-red-500/5 border border-red-500/20 text-red-400 text-sm shadow-[0_0_15px_rgba(239,68,68,0.1)] animate-in fade-in slide-in-from-top-2 duration-300">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    {loginError === "Verify your email address to login" && (
                      <Link to="/resend-verification" className="font-medium text-[#fafafa] underline-offset-4 hover:underline text-xs shrink-0">
                        Verify
                      </Link>
                    )}
                  </div>
              ...
              <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#09090b] px-2 text-[#a1a1aa]">Or continue with</span></div>
              </div>
