...
import { resendVerificationAction } from "@/utils/actions/authorize.actions";
  ...
  const onSubmit = async ({ identifier }) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        setMessage(result.message || "Verification link sent! Check your email.");
      }
    } catch (e) {
        ...
        <div className="glass-card rounded-xl p-8 shadow-2xl">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-[#a1a1aa] mt-2">
              Enter your username or email address and we'll send you a new verification link.
            </p>
          </div>
